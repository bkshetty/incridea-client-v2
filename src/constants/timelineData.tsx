...
// Local shims to avoid missing dependencies/components in this Vite app
const Image = (props: React.ImgHTMLAttributes<HTMLImageElement>) => <img {...props} />;
const EventsAdmin = () => null;
const CapturesAdmin = () => null;
const TeamAdmin = () => null;
const ManageRoles = () => null;
const RemovalRequest = () => null;
const ControlComponent = () => null;
const SMCUploads = () => null;
const Stories = () => null;
const ApproveCaptures = () => null;
const Role = { admin: "admin", manager: "manager", editor: "editor" } as const;
const AdminPlayBacks = () => null;
const AuditLogs = () => null;
const DownloadLogs = () => null;
