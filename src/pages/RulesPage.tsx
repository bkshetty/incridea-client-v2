      ...
      <div className="min-h-screen text-white relative overflow-x-hidden">
        ...
        <div className="px-4 pb-16 pt-10 md:px-6 relative z-10">
          <div className="mx-auto flex max-w-7xl flex-col gap-8">
            <LiquidGlassCard>
              <div className="mb-8">
                <h1 className="text-4xl tracking-wider md:text-5xl font-life-craft text-white drop-shadow-[0_0_15px_rgba(216,180,254,0.3)] font-moco font-bold">Terms and Conditions</h1>
                <p className="mt-1 text-xs md:text-sm font-bold uppercase tracking-[0.3em] text-purple-300/60 font-moco">Guidelines & Regulations</p>
              </div>
              ...
              <div className="flex flex-col gap-8 text-white">
                <section className="flex flex-col gap-3">
                  <h2 className="text-2xl text-purple-300 font-moco font-bold">Overview</h2>
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-2xl text-purple-300 font-moco font-bold">Section 1 - Incridea 2026 Participation Terms</h2>
                  <p className="font-moco">
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-2xl text-purple-300 font-moco font-bold">Section 2 - General Conditions for Incridea 2026 Participation</h2>
                  <p className="font-moco">
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-2xl text-purple-300 font-moco font-bold">Section 3 - Accuracy, Completeness and Timeliness of Information</h2>
                  <p className="font-moco">
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-2xl text-purple-300 font-moco font-bold">Section 4 - Modifications to Incridea 2026 and Registration Prices</h2>
                  <p className="font-moco">
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-2xl text-purple-300 font-moco font-bold">Section 5 - Events and Services at Incridea 2026</h2>
                  <p className="font-moco">
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-2xl text-purple-300 font-moco font-bold">Section 6 - Accuracy of Registration and Account Information</h2>
                  <p className="font-moco">
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-2xl text-purple-300 font-moco font-bold">Section 7 - Optional Tools</h2>
                  <p className="font-moco">
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-2xl text-purple-300 font-moco font-bold">Section 8 - Third-party Links</h2>
                  <p className="font-moco">
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-2xl text-purple-300 font-moco font-bold">Section 9 - User Comments, Feedback, and Other Submissions</h2>
                  <p className="font-moco">
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-2xl text-purple-300 font-moco font-bold">Section 10 - Personal Information</h2>
                  <p className="font-moco">
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-2xl text-purple-300 font-moco font-bold">Section 11 - Errors, Inaccuracies and Omissions</h2>
                  <p className="font-moco">
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-2xl text-purple-300 font-moco font-bold">Section 12 - Prohibited Uses</h2>
                  <p className="font-moco">
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-2xl text-purple-300 font-moco font-bold">Section 13 - Disclaimer of Warranties; Limitation of Liability</h2>
                  <p className="font-moco">
                    We do not guarantee, represent, or warrant that your use of our service will be uninterrupted, timely,
                    secure, or error-free.
                  </p>
                  <p className="font-moco">We do not warrant that the results that may be obtained from the use of the event will be accurate or reliable.</p>
                  <p className="font-moco">
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-2xl text-purple-300 font-moco font-bold">Section 14 - Indemnification</h2>
                  <p className="font-moco">
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-2xl text-purple-300 font-moco font-bold">Section 15 - Severability</h2>
                  <p className="font-moco">
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-2xl text-purple-300 font-moco font-bold">Section 16 - Termination</h2>
                  <p className="font-moco">
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-2xl text-purple-300 font-moco font-bold">Section 17 - Entire Agreement</h2>
                  <p className="font-moco">
                  ...
                  <p className="font-moco">Any ambiguities in the interpretation of these Terms of Service shall not be construed against the drafting party.</p>
                </section>

                <section className="flex flex-col gap-3">
                  <h2 className="text-2xl text-purple-300 font-moco font-bold">Section 18 - Governing Law</h2>
                  <p className="font-moco">
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-2xl text-purple-300 font-moco font-bold">Section 19 - Changes to Terms of Service</h2>
                  <p className="font-moco">
                ...
                <section className="flex flex-col gap-3">
                  <h2 className="text-2xl text-purple-300 font-moco font-bold">Section 20 - Contact Information</h2>
                  <p className="font-moco">
