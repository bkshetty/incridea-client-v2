...
const Leaderboard = () => {
  ...
  return (
    <>
      ...
      <div className="text-white p-3 md:p-6 font-sans selection:bg-transparent overflow-x-hidden">
        <div className="max-w-6xl mx-auto mb-10 md:mb-25">
          ...
          <div className="flex justify-center">
            <Glass className="flex border border-white/20 p-1.5 rounded-full shadow-2xl overflow-x-auto max-w-full">
              {/* Added whitespace-nowrap and adjusted padding/text for mobile */}
              <button 
        ...
        {/* Podium Section */}
        {/* Added scale-[0.6] for mobile to fit the 3D scene without breaking it */}
        ...
        <div className="max-w-5xl mx-auto mt-12 pb-10">
