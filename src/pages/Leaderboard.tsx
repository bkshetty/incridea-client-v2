    ...
    <>
      <style>{`
        ...
        @keyframes smokeBurst {
          ...
          100% {
            transform: scale(5) translate(0, -400px);
            opacity: 0;
          }
        }
        @keyframes smokeLeft {
          ...
          100% {
            transform: scale(4) translate(-400px, -300px);
            opacity: 0;
          }
        }
        ...
        @keyframes smokeBottomLeft {
          ...
          100% {
            transform: scale(3.5) translate(-350px, 100px);
            opacity: 0;
          }
        }
      ...
      `}</style>
    <div className=" text-white p-4 md:p-6 font-sans selection:bg-transparent ">
      <div className="max-w-6xl mx-auto mb-25">
        <div className="text-center mb-6">
          <h1 className="text-5xl md:text-6xl font-black mb-2 bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent">
        ...
        <div className="flex justify-center">
          <Glass className="flex border border-white/20 p-1.5 rounded-full shadow-2xl">
            <button 
              onClick={() => setActiveTab('quiz')}
              className={`px-6 md:px-8 py-2.5 rounded-full font-bold text-sm transition-all duration-300 ${
                activeTab === 'quiz' 
      ...
      <div className="max-w-5xl mx-auto mb-9">
        <div className="flex justify-center items-end gap-9 relative" style={{ perspective: '1200px' }}>
      ...
      <div className="max-w-4xl mx-auto mt-6 relative z-30">
            ...
            <div className="flex items-center gap-4">
              <div className="text-center">
                ...
                <div className="flex items-center gap-1">
                  <img src="/leaderboard/diamond-removebg-preview.png" alt="crystal" className="w-8 h-8 object-contain transition-all duration-300 hover:drop-shadow-[0_0_20px_rgba(168,85,247,1)] hover:brightness-110 hover:scale-110 cursor-pointer" />
            ...
            <Glass key={user.rank} className="border border-white/10 rounded-xl p-3 md:p-4 hover:border-purple-500/40 hover:shadow-[0_0_25px_rgba(168,85,247,0.2)] transition-all duration-300 group">
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="flex-shrink-0">
                  <div className={`border border-white/10 rounded-lg px-3 md:px-4 py-1.5 backdrop-blur-md bg-white/5 flex flex-row items-center justify-center gap-2 hover:scale-105 transition-all w-[130px] md:w-[150px] ${index === 0 ? 'border-blue-400/40' : index === 1 ? 'border-purple-400/40' : 'border-pink-400/40'}`}>
                    <img src="/leaderboard/diamond-removebg-preview.png" alt="crystal" className="w-7 h-7 md:w-8 md:h-8 object-contain flex-shrink-0 transition-all duration-300 hover:drop-shadow-[0_0_20px_rgba(168,85,247,1)] hover:brightness-110 hover:scale-110 cursor-pointer" />
                    <span className="text-base md:text-lg font-black text-white whitespace-nowrap">{user.reward.toLocaleString()}</span>
                  </div>
                </div>
              </div>
            </Glass>
